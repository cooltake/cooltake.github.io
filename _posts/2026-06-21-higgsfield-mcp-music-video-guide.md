---
layout: post
title: "Higgsfield MCPの料金と使い方｜AI動画の作り方"
description: "Higgsfield MCPの料金プランと使い方を解説。Claude Codeに接続してAIミュージックビデオを作る手順を、セットアップから楽曲生成・映像制作・字幕編集まで入門者向けに説明します。"
date: 2026-06-21
...
<div style="margin:2rem 0;padding:1.2rem 1.5rem;background:#1e1b4b;border-left:4px solid #818cf8;border-radius:8px;">
<p style="margin:0 0 .5rem;font-weight:bold;font-size:1rem;color:#e0e7ff;">&#x1F3AC; このガイドで使ったAI動画ツール</p>
<p style="margin:0 0 .8rem;font-size:.92rem;color:#c7d2fe;">Sora・Kling・Veo・Seedance 2.0など30以上のモデルを一か所で利用できます。Claude Code MCPで直接呼び出せるのはHiggsfield AIだけです。</p>
<p style="margin:0;font-size:.95rem;"><a href="https://higgsfield.ai" rel="nofollow" target="_blank" referrerpolicy="no-referrer-when-downgrade" style="color:#a5b4fc;font-weight:bold;text-decoration:underline;">Higgsfield AI 公式サイト（無料アカウントで開始可）→</a></p>
</div>
