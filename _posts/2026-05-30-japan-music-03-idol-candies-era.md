...
image: /assets/images/thumb-idol-candies.jpg
---

## 歌謡職人たちが作った黄金時代

1974年〜1978年——この数年間、日本の音楽シーンはキャンディーズとピンクレディーの2大勢力によって塗り替えられた。しかし彼女たちの輝きを支えていたのは、裏方に徹した**音楽職人たち**だった。
...
「春一番」のイントロから感じる解放感は、フルートとストリングスの絶妙な組み合わせから生まれる。穂口雄右のアレンジの特徴：

- **キー**：Aメジャー（明るく開放的）
- **テンポ**：ミドルテンポ（♩=約112）
- **イントロ**：フルートのオブリガートが春風を表現
...
渚のシンドバッドの特徴的なイントロは、メジャーとマイナーを行き来するコード進行：

```
E → F#m → C#m → A → E → B（転調感を出す）
```

阿久悠の歌詞「お呼びでない、お呼びでない、こりゃまた失礼しました」は、視聴者参加型のコメディ要素をアイドル楽曲に持ち込んだ革命的な試みだった。
...
1. **スネアに僅かなゆらぎ**：グリッドから±5〜10ms程度オフセット
2. **ハットは16分で刻む**：ベロシティを交互に変化（強弱のパターン）
3. **ベースドラムは1・3拍を基本に**：2拍目にゴーストノートを入れると◎
...
キャンディーズ・ピンクレディー時代の音楽は「売れるための計算」と「職人の技術」が高次元で融合した結果だった。都倉俊一が語ったヒット歌謡曲の法則：

1. **最初の8小節で全てを決める**：イントロと最初のAメロでリスナーを掴む
2. **サビは「感情の頂点」として設計する**：メロディの最高音はサビに置く
3. **繰り返し可能なメロディ**：口ずさめる単純さと覚えやすさを両立
4. **ダンスとの連動**：ピンクレディーのダンスを前提にリズムを設計

現代のDTMクリエイターが学べる最大の教訓は、**シンプルな構造の中にこそ無限の深みがある**ということかもしれない。
